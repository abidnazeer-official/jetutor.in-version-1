...
export const MRD260824 = () =>{
    ...
    return(
        <>
            ...
            <div align = "center">
                <img src={imageUrl260824_1} alt="Failed to load, please refresh the page" height={450} width={400}/>
            </div>
            <div align = "center">
                <img src={imageUrl260824_2} alt="Failed to load, please refresh the page" height={450} width={400}/>
            </div>
            <div align = "center">
                <img src={imageUrl260824_3} alt="Failed to load, please refresh the page" height={450} width={400}/>
            </div>
            <div align = "center">
                <img src={imageUrlCongrats260824_4} alt="Failed to load, please refresh the page" height={450} width={400}/>
            </div>
        </>
    )
} 