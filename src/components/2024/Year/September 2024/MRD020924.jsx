...
export const MRD020924 = () =>{
    ...
    return(
        <>
            ...
            <div align="center">
                <img src={imageUrl020924_1} alt="Failed to load, plrease refresh the page" height={450} width={400}/>
            </div>
            <div align="center">
                <img src={imageUrl020924_2} alt="Failed to load, plrease refresh the page" height={450} width={400}/>
            </div>
            <div align="center">
                <img src={imageUrl020924_3} alt="Failed to load, plrease refresh the page" height={450} width={400}/>
            </div>
            <div align="center">
                <img src={imageUrlCongrats020924_4} alt="Failed to load, plrease refresh the page" height={450} width={400}/>
            </div>
        </>
    )
}