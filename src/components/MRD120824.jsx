...
export const MRD120824 = () =>{
    ...
    return(
        <>
            ...
            <div align = "center">
                <img src={imageUrl120824_1} alt="Failed to load, please refresh the page" height={450} width={400}/>
            </div>
            <div align = "center">
                <img src={imageUrl120824_2} alt="Failed to load, please refresh the page" height={450} width={400}/>
            </div>
            <div align="center">
                <img src={imageUrl120824_3} alt="Failed to load, please refresh the page" height={450} width={400}/>
            </div>
            <div align = "center">
                <img src={imageUrlCongrats_4} alt="Failed to load, please refresh the page" height={450} width={400}/>
            </div>
        </>
    )
}